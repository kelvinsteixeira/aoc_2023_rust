...
pub const INPUT: &str = "14gxqgqsqqbxfpxnbccjc33eight
eight2sevenkl
...
pub const NUMBER_NAMES: [&str; 10] = [
    "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine",
];

pub fn get_number_map() -> HashMap<&'static str, u32> {
    let mut non_snake_case: HashMap<&str, u32> = HashMap::new();
    non_snake_case.insert("zero", 0);
    non_snake_case.insert("one", 1);
    non_snake_case.insert("two", 2);
    non_snake_case.insert("three", 3);
    non_snake_case.insert("four", 4);
    non_snake_case.insert("five", 5);
    non_snake_case.insert("six", 6);
    non_snake_case.insert("seven", 7);
    non_snake_case.insert("eight", 8);
    non_snake_case.insert("nine", 9);
